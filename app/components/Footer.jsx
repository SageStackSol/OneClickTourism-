  ...
  return (
    <>
      ...
      <div className="bg-[#7B7B78] lg:px-20 lg:py-10 md:lg-20 md:py-10 px-4 py-2">
        <h2 className="text-5xl font-bold leading-normal mb-8 lg:text-left md:text-left text-center">
          Get in Touch
        </h2>
        <input
          placeholder="Email or Mobile Number"
          className="bg-[#D9D9D9] lg:w-[32vw] md:w-[32vw] w-full h-9 rounded-md focus:outline-none lg:mr-8 md:mr-8 px-2"
        />
